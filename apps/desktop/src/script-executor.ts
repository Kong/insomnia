...
import { initInsomniaObject, InsomniaObject } from '../../../packages/insomnia-scripting-environment/src/objects';
import {
  getNewConsole,
  ...
  mergeSettings,
  type RequestContext,
} from '../../../packages/insomnia-scripting-environment/src/objects';
