...
export const IN_SANDBOX_BOOTSTRAP = [
  ...
  // Mirrors apps/desktop/src/plugins/context/request.ts. Getters always present; mutators
  ...
  // Mirrors apps/desktop/src/plugins/context/response.ts. No readOnly variant (response.ts has
