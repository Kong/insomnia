...
import { ControlledCheckboxDemo, SelectAllDemo } from './CheckboxDemo';
...
- `color-font`: Text color for labels
- `color-success`: Checkmark/minus icon color (green)
- `hl-xs`: Checked box background
- `hl-sm`: Box border color (ring-1);
