...
- [Insomnia Smoke Tests](#insomnia-smoke-tests)
  ...
  - [Reproducing CI Failures](#reproducing-ci-failures)
    ...
    - [Non recurring CI tests](#non-recurring-ci-tests)
...
### Non recurring CI tests

Non recurring CI tests, like pre-release ones, can be run using [Playwright VS Code extension](#playwright-vs-code-extension) or by running `test:dev` against the desired test file:
