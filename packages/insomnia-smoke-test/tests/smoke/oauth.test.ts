...
test("can make oauth2 requests", async ({ app, page }) => {
  ...
  await page
    .getByLabel("Request Collection")
    .getByTestId("Request with Inherited Auth")
    .press("Enter");
  await expect(page.locator(".app")).toContainText(
    "http://127.0.0.1:4010/oidc/me",
  );
  ...
  await page
    .getByLabel("Request Collection")
    .getByTestId("ID Token")
    .press("Enter");
  await expect(page.locator(".app")).toContainText(
    "http://127.0.0.1:4010/oidc/id-token",
  );
  ...
  await page
    .getByLabel("Request Collection")
    .getByTestId("ID and Access Token")
    .press("Enter");
  await expect(page.locator(".app")).toContainText(
    "http://127.0.0.1:4010/oidc/me",
  );
  ...
  await page
    .getByLabel("Request Collection")
    .getByTestId("Client Credentials")
    .press("Enter");
  await expect(page.locator(".app")).toContainText(
    "http://127.0.0.1:4010/oidc/client-credential",
  );
  ...
  await page
    .getByLabel("Request Collection")
    .getByTestId("Resource Owner Password Credentials")
    .press("Enter");
  await expect(page.locator(".app")).toContainText(
    "http://127.0.0.1:4010/oidc/me",
  );
