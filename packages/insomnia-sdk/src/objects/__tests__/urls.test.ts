...
describe("test Url object", () => {
  it("test QueryParam", () => {
    ...
    expect(QueryParam.parseSingle("uname=patrick+star")).toEqual({
      key: "uname",
      value: "patrick star",
    });
  ...
  it("test Url methods", () => {
    ...
    expect(url.getPathWithQuery()).toEqual(
      "/pathLevel1/pathLevel2?key1=value1&key2=value2&key3=value3",
    );
    ...
    expect(url2.getPathWithQuery()).toEqual(
      "/pathLevel1/pathLevel2?key1=value1&key2=value2",
    );
  ...
  it("test Url property accessing", () => {
    const urlStr =
      "https://user:pwd@hehe.com:6666/path1/path2?q1=@&q2=:#myHash";
