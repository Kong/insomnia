...
export function authOptionsToParams(
  ...
  return Object.entries(authMethod).map((entry) => ({
    type: "any",
    key: entry[0],
    value: entry[1],
  }));
...
function rawOptionsToVariables(
  options: VariableList<Variable> | Variable[] | AuthOptions,
  targetType?: string,
...
export class RequestAuth extends Property {
  ...
  constructor(options: AuthOptions, parent?: Property) {
    ...
    const optsObj = options as AuthOptions;
    const optsEntries = Object.entries(optsObj).filter(
      (optsObjEntry) => optsObjEntry[0] !== "type",
    );
  ...
  switch (authObj.type) {
    ...
    case "basic":
      return {
        ...
        useISO88591:
          findValueInKvArray("useISO88591", authObj.basic) === "true",
    ...
    case "oauth1":
      ...
      return {
        ...
        includeBodyHash:
          findValueInKvArray("includeBodyHash", authObj.oauth1) === "true",
      };
    case "oauth2":
      const inputGrantType = findValueInOauth2Options(
        "grant_type",
        authObj.oauth2,
      );
      const grantType = (() => {
      ...
      return {
        type: "oauth2",
        disabled:
          findValueInOauth2Options("disabled", authObj.oauth2) === "true",
        grantType: grantType,
        authorizationUrl: findValueInOauth2Options("authUrl", authObj.oauth2),
        accessTokenUrl: findValueInOauth2Options(
          "accessTokenUrl",
          authObj.oauth2,
        ),
        ...
        pkceMethod: findValueInOauth2Options(
          "challengeAlgorithm",
          authObj.oauth2,
        ),
        usePkce:
          findValueInOauth2Options("grant_type", authObj.oauth2) ===
        ...
        refreshToken: findValueInOauth2Options(
          "refreshTokenUrl",
          authObj.oauth2,
        ),
        credentialsInBody:
          findValueInOauth2Options("client_authentication", authObj.oauth2) ===
          "body",
    ...
    case "hawk":
      return {
        ...
        algorithm:
          findValueInKvArray("algorithm", authObj.hawk) === "sha256"
            ? "sha256"
            : "sha1",
        ...
        validatePayload:
          findValueInKvArray("validatePayload", authObj.hawk) === "true",
...
export function toPreRequestAuth(
    ...
    case "oauth1":
      return {
        ...
        oauth1: [
          ...
          {
            key: "includeBodyHash",
            value: auth.includeBodyHash ? "true" : "false",
          },
        ],
      };
    case "oauth2":
      ...
      return {
        ...
        oauth2: [
          ...
          { key: "refreshTokenUrl", value: auth.refreshToken || "" },
          {
            ...
            value: auth.credentialsInBody ? "body" : "header",
          },
    ...
    case "hawk":
      return {
        ...
        hawk: [
          ...
          {
            key: "validatePayload",
            value: auth.validatePayload ? "true" : "false",
          },
