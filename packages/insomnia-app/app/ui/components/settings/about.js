  ...
  render() {
    return (
      <div>
        ...
        <p>
          Insomnia started as a side-project of mine in 2014 and transitioned into what I do
          full-time in mid 2016.
        </p>
        <p>
          If you have any question or concerns, don't hesitate to{' '}
          <Link href="https://insomnia.rest/support/">reach out</Link>. And, if you want access to
