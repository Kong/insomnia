...
const main: Window['main'] = {
  ...
  mkdir: options => ipcRenderer.invoke('mkdir', options),
  fileExists: options => ipcRenderer.invoke('fileExists', options),
  deleteFile: options => ipcRenderer.invoke('deleteFile', options),
