...
const main: Window['main'] = {
  ...
  clearImportResourceCache: () => ipcRenderer.invoke('clearImportResourceCache'),
  curlRequest: options => ipcRenderer.invoke('curlRequest', options),
  cancelCurlRequest: options => ipcRenderer.send('cancelCurlRequest', options),
  fetchImportContentFromURI: options => ipcRenderer.invoke('fetchImportContentFromURI', options),
  findExistingImportedSpec: (...args) => ipcRenderer.invoke('findExistingImportedSpec', ...args),
  findRequestInExistingWorkspace: (...args) => ipcRenderer.invoke('findRequestInExistingWorkspace', ...args),
  importResourcesToNewWorkspace: options => ipcRenderer.invoke('importResourcesToNewWorkspace', options),
  importResourcesToProject: options => ipcRenderer.invoke('importResourcesToProject', options),
  importResourcesToWorkspace: options => ipcRenderer.invoke('importResourcesToWorkspace', options),
  importScannedResources: options => ipcRenderer.invoke('importScannedResources', options),
  ...
  scanImportResources: options => ipcRenderer.invoke('scanImportResources', options),
  scanResources: (...args) => ipcRenderer.invoke('scanResources', ...args),
