...
vi.mock('insomnia-data', () => ({
  services: {
    ...
    requestVersion: { findByParentId: vi.fn(), restore: vi.fn(), getRequest: vi.fn() },
    response: { create: vi.fn(), getByBodyPath: vi.fn(), getById: vi.fn(), getLatestForRequestId: vi.fn(), findByParentId: vi.fn() },
    ...
    socketIOResponse: { getById: vi.fn(), findByParentId: vi.fn(), getLatestForRequestId: vi.fn() },
    stats: {
    ...
    webSocketResponse: { getById: vi.fn(), findByParentId: vi.fn(), getLatestForRequestId: vi.fn() },
    workspace: {
...
const CASES: { handlerName: keyof typeof handlers; serviceName: string; methodName: string; args: unknown[] }[] = [
  ...
  { handlerName: 'requestVersionGetRequest', serviceName: 'requestVersion', methodName: 'getRequest', args: [{ _id: 'rv1', compressedRequest: 'x' }] },
  ...
  { handlerName: 'responseFindByParentId', serviceName: 'response', methodName: 'findByParentId', args: ['req1'] },
  ...
  { handlerName: 'socketIOResponseGetById', serviceName: 'socketIOResponse', methodName: 'getById', args: ['res1'] },
  { handlerName: 'socketIOResponseFindByParentId', serviceName: 'socketIOResponse', methodName: 'findByParentId', args: ['req1'] },
  { handlerName: 'socketIOResponseGetLatestForRequestId', serviceName: 'socketIOResponse', methodName: 'getLatestForRequestId', args: ['req1', null] },
  ...
  { handlerName: 'webSocketResponseGetById', serviceName: 'webSocketResponse', methodName: 'getById', args: ['res1'] },
  { handlerName: 'webSocketResponseFindByParentId', serviceName: 'webSocketResponse', methodName: 'findByParentId', args: ['req1'] },
  { handlerName: 'webSocketResponseGetLatestForRequestId', serviceName: 'webSocketResponse', methodName: 'getLatestForRequestId', args: ['req1', null] },
