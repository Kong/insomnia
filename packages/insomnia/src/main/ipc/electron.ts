...
export type HandleChannels =
  ...
  | 'services.response.findByParentId'
  ...
  | 'services.socketIOResponse.getById'
  | 'services.socketIOResponse.findByParentId'
  | 'services.socketIOResponse.getLatestForRequestId'
  | 'services.stats.get'
  ...
  | 'services.webSocketResponse.getById'
  | 'services.webSocketResponse.findByParentId'
  | 'services.webSocketResponse.getLatestForRequestId'
