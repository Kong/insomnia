...
export const ErrorRoute: FC<{ defaultMessage?: string }> = ({
  defaultMessage,
}) => {
  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-center gap-2 overflow-hidden">
      <h1 className="flex items-center gap-2 text-2xl text-[--color-font]">
        <Icon className="text-[--color-danger]" icon="exclamation-triangle" />{" "}
        Application Error
      </h1>
      <p className="text-[--color-font]">
        ...
        <a
          ...
          href="https://github.com/Kong/insomnia/issues"
        >
          our Github Issues
        </a>
      </p>
