...
export const loader: LoaderFunction = async ({
  params,
}): Promise<RequestGroupLoaderData> => {
...
export const createRequestGroupAction: ActionFunction = async ({
  ...
  const environmentType =
    (formData.get("environmentType") as EnvironmentType) ||
...
export const updateRequestGroupMetaAction: ActionFunction = async ({
  ...
  const requestGroupMeta =
    await models.requestGroupMeta.getByParentId(requestGroupId);
  if (requestGroupMeta) {
