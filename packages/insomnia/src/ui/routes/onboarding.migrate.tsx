...
export const action: ActionFunction = async ({ request }) => {
  ...
  invariant(
    ...
    "Expected type to be either local or remote",
  );
            ...
            <div className="flex h-full flex-col items-center justify-center pt-2">
              <div className="flex flex-col gap-4 text-[--color-font]">
                ...
                <div className="flex flex-col gap-4">
                  <p>
                    With Cloud Sync your projects will be automatically
                    synchronized to the cloud in an encrypted way and available
                    on every Insomnia client after logging in for ease of use
                    and collaboration.
                  </p>
                </div>
                  ...
                  >
                    <div className="flex gap-2">
                      ...
                      >
                        ...
                        <p className="pt-2">
                          Encrypted and synced securely to the cloud, ideal for
