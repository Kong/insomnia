...
export const createVaultKeyAction: ActionFunction = async () => createVaultKey('create');

export const resetVaultKeyAction: ActionFunction = async () => createVaultKey('reset');
