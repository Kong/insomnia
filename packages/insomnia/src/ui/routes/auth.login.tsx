  ...
  return (
    <div className="flex flex-col gap-[--padding-lg]">
      <div className="flex flex-col gap-[--padding-md]">
        <p className="py-[--padding-md] text-center text-2xl text-[--color-font]">
        ...
        <div className="text-sm font-extrabold [text-wrap:balance]">
          ...
          <span className="ml-1 text-[--color-font]">
            APIs locally, on Git or in the Cloud.
          </span>
        </div>
        {message && (
          <div className="text-sm font-bold text-red-300">{message}</div>
        )}
        <Button
