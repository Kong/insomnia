          ...
          {pluginNodeExtraCerts !== '' && (
            <div className="mt-4 flex flex-col justify-between gap-2">
              <div className="flex h-20 w-full gap-2">
                ...
                <Button
                  className="flex h-(--line-height-xs) items-center justify-center rounded-md border border-solid border-(--hl-lg) px-(--padding-md) text-(--color-font) ring-1 ring-transparent transition-all hover:bg-(--hl-xs) focus:ring-inset focus:ring-(--hl-md) aria-pressed:bg-(--hl-sm)"
                  onPress={() => {
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            {plugins.length > 0 && (
              <div className="flex flex-1 items-center justify-end gap-2">
                <Button
                  className="flex h-(--line-height-xs) items-center justify-center gap-2 rounded-md border border-solid border-(--hl-lg) px-(--padding-md) py-1 text-sm font-semibold text-(--color-font) ring-1 ring-transparent transition-all hover:bg-(--hl-xs) focus:ring-inset focus:ring-(--hl-md) aria-pressed:bg-(--hl-sm)"
            ...
            <GridList
              ...
              renderEmptyState={() => (
                <div className="flex h-36 flex-col items-center">
                  ...
                  <Button
                    className="mt-4 flex h-(--line-height-xs) items-center justify-center gap-2 rounded-md border border-solid border-(--hl-lg) px-(--padding-md) py-1 text-sm font-semibold text-(--color-font) ring-1 ring-transparent transition-all hover:bg-(--hl-xs) focus:ring-inset focus:ring-(--hl-md) aria-pressed:bg-(--hl-sm)"
                    onPress={() => setShowCreatePluginModal(true)}
                    isDisabled={isRefreshingPlugins}
                  >
                    New Plugin
