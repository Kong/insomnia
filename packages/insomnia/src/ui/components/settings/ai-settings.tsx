  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="rounded-md border border-solid border-[--hl-sm] bg-[--hl-xs] p-4">
        <div className="flex flex-col gap-4">
          <div>
            <h3 className="text-base font-semibold text-[--color-font] mb-3">AI Features</h3>
            {!hasActiveLLM ? (
              <p className="text-sm text-[--hl] mb-4">
                Configure and activate an LLM below to enable AI features.
              </p>
            ) : (
              <p className="text-sm text-[--color-font] mb-4">
                Enable AI-powered features in Insomnia.
              </p>
            )}
          </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex flex-col gap-1">
              <span className="text-sm font-medium text-[--color-font]">Auto-generate Mock Servers from natural language</span>
            ...
            >
              <div className="flex h-6 w-11 cursor-pointer items-center rounded-full border-2 border-solid border-transparent bg-[--hl-md] transition-colors group-data-[selected]:bg-[--color-surprise] group-data-[disabled]:opacity-50 group-data-[disabled]:cursor-not-allowed">
          ...
          <div className="flex items-center justify-between">
            <div className="flex flex-col gap-1">
              ...
              {!isCommitMessagesEnabledByOrg ? (
                <p className="text-xs text-[--color-danger]">
                  Disabled by organization{features.aiCommitMessages?.reason ? `: ${features.aiCommitMessages.reason}` : ''}
                </p>
              ) : !hasActiveLLM ? (
                <p className="text-xs text-[--hl]">
                  Configure and activate an LLM to enable this feature
