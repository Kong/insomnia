...
export const GGUF = ({
  ...
  const userDataPath = path.resolve(globalThis.app.getPath('userData'));
  const llmsFolder = path.resolve(userDataPath, LLMS_FOLDER_NAME);
  ...
  return (
    <div className="flex w-full flex-col gap-2">
      ...
      <Text className="text-xs">
        ...
        <Button className="underline" onClick={() => globalThis.shell.openPath(llmsFolder)}>
          the LLMs folder
        </Button>
      </Text>
      {selectedModel && (
