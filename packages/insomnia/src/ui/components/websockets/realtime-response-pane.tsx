...
import { type McpResponse, models } from '~/insomnia-data';
import { type RequestVersion, type Response, type SocketIOResponse, type WebSocketResponse } from '~/insomnia-data';
...
const RealtimeActiveResponsePane: FC<RealtimeActiveResponsePaneProps & { readyState: ReadyState }> = ({
  ...
  const isLongRunning = models.socketIOResponse.isSocketIOResponse(response) || models.mcpResponse.isMcpResponse(response);
  const hideCookies = models.socketIOResponse.isSocketIOResponse(response) || models.mcpResponse.isMcpResponse(response);
  const hideHeaders =
