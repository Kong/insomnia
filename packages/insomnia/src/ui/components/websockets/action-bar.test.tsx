...
describe('<WebSocketActionBar />', () => {
  test('renders without exploding', async () => {
    ...
    expect(screen.getByPlaceholderText('wss://websocket-example')).toBeDefined();
    ...
    await waitFor(() => {
      const urlInput: HTMLInputElement = screen.getByPlaceholderText('wss://websocket-example');
      expect(urlInput.value).toBe('wss://websocket-example');
    });
  });
  ...
  test('calls close method when the component gets unmounted', async () => {
    const mockOnChangeEvent = new EventEmitter();
    const mockDbClient = getMockDbClient(mockOnChangeEvent);
