...
import { type CloudProviderCredential, type CloudProviderName } from '../../../../models/cloud-credential';
...
export const ExternalVaultForm = (props: ArgConfigFormProps) => {
  ...
  const cloudCredentialDocs = (docs[databaseSchema.CloudCredential.type] as CloudProviderCredential[]) || [];
