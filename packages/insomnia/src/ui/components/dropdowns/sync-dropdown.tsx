          ...
          >
            {syncError && (
              <MenuSection className="border-b border-solid border-(--hl-sm)">
                <MenuItem
                  className={
                    'text-md flex w-full items-center gap-2 overflow-hidden whitespace-nowrap bg-transparent px-(--padding-md) text-(--color-font) transition-colors focus:outline-hidden disabled:cursor-not-allowed aria-selected:font-bold'
                  }
