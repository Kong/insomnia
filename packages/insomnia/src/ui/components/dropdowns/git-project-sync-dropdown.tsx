            ...
            >
              ...
              <div className="relative flex items-center">
                ...
                {pendingChangesCount > 0 && (
                  <div className="absolute -bottom-2 -right-1 h-[12px] min-w-[12px] bg-(--color-surprise) px-[4px] text-center font-semibold text-(--color-font-surprise) rounded-[20px] text-[6px] [line-height:12px]">
                    {pendingChangesCount}
                  </div>
                )}
              </div>
