...
export const WorkspaceDropdown: FC<{}> = () => {
  ...
  const [
    ...
    setIsDeleteRemoteWorkspaceModalOpen,
  ] = useState(false);
  ...
  const handlePluginClick = useCallback(
    async (
      { action, plugin, label }: WorkspaceAction,
      workspace: Workspace,
    ) => {
  ...
  const actionlist = isScratchpadWorkspace
    ? scratchpadActionList
                ...
                <div className="flex flex-col gap-4">
                  ...
                  >
                    ...
                    <p>
                      ...
                      {isRemoteProject(activeProject) ? "remotely" : ""}.
                    </p>
                    {deleteWorkspaceFetcher.data &&
