...
export const RequestSettingsModal = ({
  request,
  onHide,
}: ModalProps & RequestSettingsModalOptions) => {
  ...
  async function handleMoveToWorkspace() {
    ...
    navigate(
      `/organization/${organizationId}/project/${projectId}/workspace/${workspaceToCopyTo}/debug`,
    );
  }
  ...
  const updateReflectonApi = async (
            ...
            <div className="form-control form-control--outlined">
              <label>
                ...
                <input
                  ...
                  onChange={(event) =>
                    patchRequest(request._id, { name: event.target.value })
                  }
                />
              </label>
            </div>
                  ...
                  <div className="form-control form-control--outlined">
                    <label>
                      ...
                      <HelpTooltip position="top" className="space-left">
                        Copy or move the current request to a new workspace. It
                        will be placed at the root of the new workspace's folder
                        structure.
                      </HelpTooltip>
                      <select
              ...
              <>
                <div className="form-control form-control--thin pad-top-sm">
                  <label>
                    ...
                    <a
                      href="https://buf.build/docs/bsr/reflection/overview"
                    ...
                    <>
                      <div className="form-control form-control--outlined">
                        <label>
                          ...
                          <a
                            href="https://buf.build/docs/bsr/api-access"
                            className="pad-left-sm"
                          >
                            <Icon icon="external-link" size="sm" />
                          </a>
                      ...
                      <div className="form-control form-control--outlined">
                        <label>
                          ...
                          <a
                            href="https://buf.build/docs/bsr/authentication#manage-tokens"
                            className="pad-left-sm"
                          >
                            <Icon icon="external-link" size="sm" />
                          </a>
                      ...
                      <div className="form-control form-control--outlined">
                        <label>
                          Module
                          <a
                            href="https://buf.build/docs/bsr/module/manage"
                            className="pad-left-sm"
                          >
                            <Icon icon="external-link" size="sm" />
                          </a>
                ...
                <p className="faint pad-top italic">
                  ...
                  <a
                    href={"https://github.com/Kong/insomnia/issues/new/choose"}
                  >
                    feature request
                  </a>
                  !
                  ...
                  <div className="pad-top pad-bottom">
                    ...
                    <div className="form-control form-control--thin">
                      <label>
                        ...
                        />
                        <HelpTooltip position="top" className="space-left">
                          Automatically encode special characters at send time
                          (does not apply to query parameters editor)
                        </HelpTooltip>
                      </label>
                    </div>
                    <div className="form-control form-control--thin">
                      <label>
                        ...
                        />
                        <HelpTooltip position="top" className="space-left">
                          Disable rendering of environment variables and tags
                    ...
                    <div className="form-control form-control--thin">
                      <label>
                        ...
                        <HelpTooltip position="top" className="space-left">
                          This instructs libcurl to squash sequences of "/../"
                          or "/./" that may exist in the URL's path part and
                          that is supposed to be removed according to RFC 3986
                          section 5.2.4
                        </HelpTooltip>
                        <input
                          type="checkbox"
