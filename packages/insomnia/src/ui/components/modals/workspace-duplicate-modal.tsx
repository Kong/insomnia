...
export const WorkspaceDuplicateModal: FC<WorkspaceDuplicateModalProps> = ({
  workspace,
  onHide,
}) => {
  ...
  const isBtnDisabled =
    fetcher.state !== "idle" || !selectedProjectId || !newWorkspaceName;
    ...
    <OverlayContainer onClick={(e) => e.stopPropagation()}>
      <Modal onHide={onHide} ref={modalRef}>
        ...
        <ModalBody className="wide">
          <p className="mb-6">
            You can duplicate the following file to a project:
          </p>
