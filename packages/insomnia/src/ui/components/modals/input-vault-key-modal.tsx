        ...
        <Dialog className="flex h-full flex-1 flex-col overflow-hidden outline-hidden">
          {({ close }) => (
            <div className="flex flex-1 flex-col gap-4 overflow-hidden">
              ...
              {!resetDone ? (
                <>
                  <div className="flex w-full shrink-0 grow basis-12 select-none flex-col gap-3 rounded-sm">
                    <label>Unlock all secrets by entering the vault key</label>
                    <Input
                      className="w-full rounded-xs border border-solid border-(--hl-sm) bg-(--color-bg) py-1 pl-2 pr-7 text-(--color-font)"
