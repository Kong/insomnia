        ...
        <Dialog className="flex h-full flex-1 flex-col overflow-hidden outline-hidden">
          {({ close }) => (
            <div className="flex flex-1 flex-col gap-4 overflow-hidden">
              ...
              <div className="max-h-96 min-h-80 w-full select-none overflow-y-auto rounded-sm border border-solid border-(--hl-sm)">
                <Tree
                  root={state?.treeRoot}
              ...
              <div className="flex flex-1 shrink-0 items-center justify-end gap-2">
                <Button
                  onPress={close}
                  className="flex items-center gap-2 rounded-xs border border-solid border-(--hl-md) px-3 py-2 text-(--color-font) transition-colors hover:bg-opacity-90 hover:no-underline"
                >
                  Cancel
                </Button>
                <Button
                  ...
                  className="flex items-center gap-2 rounded-xs border border-solid border-(--hl-md) bg-(--color-surprise) px-3 py-2 text-(--color-font-surprise) transition-colors hover:bg-opacity-90 hover:no-underline"
                >
