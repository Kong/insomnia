                          ...
                          >
                            {item => {
                              if (editorType === 'diff') {
                                ...
                                return (
                                  <GridListItem className="relative flex w-full cursor-pointer select-none items-start justify-start gap-2 overflow-hidden px-2 py-1 text-(--hl) outline-hidden transition-colors hover:bg-(--hl-xs) focus:bg-(--hl-sm) aria-selected:bg-(--hl-sm) aria-selected:text-(--color-font)">
