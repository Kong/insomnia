      ...
      <ModalFooter>
        {!hideMode ? (
          <Dropdown
            ...
            triggerButton={
              <Button className="!hover:no-underline !hover:bg-opacity-90 rounded-xs! border! border-solid! border-(--hl-md)! bg-transparent! px-3! py-2! text-(--color-font)! transition-colors!">
                {MODES[mode]}
