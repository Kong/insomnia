...
export const NewWorkspaceModal = ({
  ...
  const isSelfHostedDisabled =
    !isEnterprise || storageRule === ORG_STORAGE_RULE.CLOUD_ONLY;
  const isCloudProjectDisabled =
    isLocalProject || storageRule === ORG_STORAGE_RULE.LOCAL_ONLY;
  ...
  const selectedFolder =
    ...
    gitRepoTreeFetcher.data?.repositoryTree.id ||
    "";
                ...
                {isGitProject(project) && gitRepoTreeFetcher.data && (
                  <>
                    <TextField
                      ...
                      validate={(fileName) => {
                        if (
                          selectedFolderChildren.includes(
                      ...
                      value={safeToUseInsomniaFileName(
                      ...
                      <Label className="group relative flex flex-col gap-2 overflow-hidden">
                        ...
                        <div className="grid w-full overflow-hidden rounded-sm border border-solid border-[--hl-sm] bg-[--color-bg] py-1 pl-2 pr-7 text-[--color-font] transition-colors [grid-template-areas:'input_extension'] [grid-template-columns:min-content_auto] focus:outline-none focus:ring-1 focus:ring-[--hl-md]">
                          <Input
                            placeholder={
                              workspaceData.name
                                ? safeToUseInsomniaFileName(workspaceData.name)
                                : "name"
                            }
                    ...
                    <Tree
                      ...
                      onSelectionChange={(selection) => {
                        if (selection !== "all") {
                          setWorkspaceData({
                            ...workspaceData,
                            folderPath: selection.values().next()
                              .value as string,
                          });
                        }
                      }}
                    ...
                    {!isSelfHostedDisabled && (
                      ...
                      >
                        ...
                        <Input
                          ...
                          placeholder={
                            workspaceData.mockServerType === "cloud"
                              ? ""
                              : "https://example.com"
                          }
                          className="w-full rounded-sm border border-solid border-[--hl-sm] bg-[--color-bg] py-1 pl-2 pr-7 text-[--color-font] transition-colors placeholder:italic focus:outline-none focus:ring-1 focus:ring-[--hl-md]"
