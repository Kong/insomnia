...
export const WorkspaceEnvironmentsEditModal = ({
  ...
  const selectedEnvironment = [baseEnvironment, ...subEnvironments].find(
    ...
    renderDropIndicator(target) {
      if (target.type === "item") {
        if (
          ...
          target.key === baseEnvironment._id
        ) {
        ...
        return (
          <DropIndicator
            target={target}
            className="outline outline-1 outline-[--color-surprise]"
          />
        );
      }
              ...
              <div className="flex w-full flex-1 basis-96 select-none divide-x divide-solid divide-[--hl-md] overflow-hidden overflow-y-auto rounded border border-solid border-[--hl-sm]">
                ...
                <div className="flex flex-1 flex-col divide-y divide-solid divide-[--hl-md] overflow-hidden">
                  <div className="flex w-full items-center justify-between gap-2 overflow-hidden px-[--padding-sm]">
                    ...
                    {selectedEnvironment &&
                      selectedEnvironment.parentId !== workspaceId && (
                  ...
                  {hasResponseTagEnvironmentVariable && (
                    <p className="warning text-sm italic">
                      ...
                      <a href={docsAfterResponseScript}>
                        {" "}
                        We suggest to save your response into an environment
                        variable using after-response script.
                      </a>
                    </p>
                  )}
                  <p className="text-sm italic">
                    * Environment data can be used for{" "}
                    <a href={docsTemplateTags}>Nunjucks Templating</a> in your
                    requests.
                  </p>
                </div>
                <Button
