        ...
        <Dialog className="flex h-full flex-1 flex-col overflow-hidden outline-hidden">
          {({ close }) => (
            <div className="flex h-full flex-1 flex-col gap-4 overflow-hidden">
              ...
              <div className="flex w-full flex-1 basis-96 select-none divide-x divide-solid divide-(--hl-md) overflow-hidden overflow-y-auto rounded-sm border border-solid border-(--hl-sm)">
                <GridList
                                ...
                                >
                                  {item => (
                                    <MenuItem
                                      key={item.id}
                                      id={item.id}
                                      className="text-md flex w-full flex-col gap-1 whitespace-nowrap bg-transparent px-(--padding-md) py-2 text-(--color-font) transition-colors hover:bg-(--hl-sm) focus:bg-(--hl-xs) focus:outline-hidden disabled:cursor-not-allowed aria-selected:font-bold"
                                      aria-label={item.name}
                                    >
