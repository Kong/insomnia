        ...
        <Dialog className="flex h-full flex-1 flex-col overflow-y-hidden outline-hidden">
          {({ close }) => (
            <div className="flex h-full flex-1 flex-col gap-4 overflow-y-hidden">
              ...
              <div className="flex w-full flex-1 basis-96 select-none flex-col gap-2 overflow-y-auto rounded-sm px-2">
                <form
                  id={formId}
                ...
                >
                  ...
                  <Tabs className="rounded-xs border border-solid border-(--hl-md)">
                    <TabList className="flex items-center border-b border-solid border-(--hl-md)">
                      <Tab
                        className="flex items-center gap-2 px-2 py-1 text-(--color-font) outline-hidden transition-colors hover:bg-(--hl-sm) hover:bg-opacity-90 hover:no-underline aria-selected:bg-(--hl-md)"
                        id="certificate"
                      >
                        Certificate
                      </Tab>
                    ...
                    <TabPanel className="p-2" id="pfx">
                      <Label className="flex flex-col gap-1" aria-label="Host">
                        ...
                        >
                          <Button className="flex h-full shrink-0 items-center justify-center gap-2 rounded-xs border border-solid border-(--hl-sm) px-2 py-1 text-base text-(--color-font) ring-1 ring-transparent transition-all hover:bg-(--hl-xs) focus:ring-inset focus:ring-(--hl-md) aria-pressed:bg-(--hl-sm) aria-selected:bg-(--hl-sm)">
                      ...
                      <Label className="flex flex-1 flex-col gap-1" aria-label="Certificate">
                        ...
                        >
                          <Button
                            ...
                            className="flex h-full shrink-0 items-center justify-center gap-2 rounded-xs border border-solid border-(--hl-sm) px-2 py-1 text-base text-(--color-font) ring-1 ring-transparent transition-all hover:bg-(--hl-xs) focus:ring-inset focus:ring-(--hl-md) aria-pressed:bg-(--hl-sm) aria-selected:bg-(--hl-sm)"
                          >
              ...
              <div className="flex items-center justify-end gap-2">
                <Button
                  onPress={close}
                  className="rounded-xs border border-solid border-(--hl-md) px-3 py-2 text-(--color-font) transition-colors hover:border-(--hl-sm) hover:bg-opacity-90 hover:no-underline"
                >
                  Cancel
                </Button>
                <Button
                  type="submit"
                  form={formId}
                  className="flex items-center gap-2 rounded-xs border border-solid border-(--hl-md) bg-[rgba(var(--color-surprise-rgb),var(--tw-bg-opacity))] bg-opacity-100 px-3 py-2 text-(--color-font-surprise) transition-colors hover:border-(--hl-sm) hover:bg-opacity-90 hover:no-underline"
                >
                  <Icon icon="plus" />
      ...
      <div className="flex w-full items-center gap-2">
        ...
        <div className="flex h-6 items-center gap-2">
          <ToggleButton
            ...
            className="flex h-full w-[12ch] shrink-0 items-center justify-start gap-2 rounded-xs px-2 text-sm text-(--color-font) ring-1 ring-transparent transition-all hover:bg-(--hl-xs) focus:ring-inset focus:ring-(--hl-md)"
          >
            {({ isSelected }) => (
              <Fragment>
                <Icon
          ...
          <Button
            ...
            className="flex aspect-square h-full shrink-0 items-center justify-center rounded-xs text-sm text-(--color-font) ring-1 ring-transparent transition-all hover:bg-(--hl-xs) focus:ring-inset focus:ring-(--hl-md) aria-pressed:bg-(--hl-sm)"
          >
            <Icon icon="trash" />
          </Button>
        </div>
        ...
        <Dialog className="flex h-full flex-1 flex-col overflow-hidden outline-hidden">
          {({ close }) => (
            <div className="flex h-full flex-1 flex-col gap-4 overflow-hidden">
              ...
              <div className="flex w-full flex-1 basis-96 select-none flex-col gap-6 overflow-hidden overflow-y-auto rounded-sm">
                <Heading className="text-xl">CA Certificate</Heading>
                <div className="flex flex-col gap-2">
                  {caCertificate ? (
                    <div className="flex items-center justify-between gap-2 rounded-xs border border-solid border-(--hl-sm) p-4">
                    ...
                    <div className="flex items-center justify-between gap-2">
                      ...
                      >
                        <Button className="flex h-full flex-1 shrink-0 items-center justify-center gap-2 rounded-xs border border-solid border-(--hl-sm) px-2 py-1 text-base text-(--color-font) ring-1 ring-transparent transition-all hover:bg-(--hl-xs) focus:ring-inset focus:ring-(--hl-md) aria-pressed:bg-(--hl-sm) aria-selected:bg-(--hl-sm)">
                          <Icon icon="plus" />
                ...
                <div className="flex items-center justify-between gap-2">
                  ...
                  <Button
                    ...
                    className="flex h-full shrink-0 items-center justify-center gap-2 rounded-xs px-2 text-base text-(--color-font) ring-1 ring-transparent transition-all hover:bg-(--hl-xs) focus:ring-inset focus:ring-(--hl-md) aria-pressed:bg-(--hl-sm) aria-selected:bg-(--hl-sm)"
                  >
                    <Icon icon="plus" />
