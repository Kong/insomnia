        ...
        <Dialog className="flex h-full flex-1 flex-col overflow-hidden outline-hidden">
          {({ close }) => (
            <div className="flex flex-1 flex-col gap-4 overflow-hidden">
              ...
              <div className="flex w-full shrink-0 grow basis-12 select-none flex-col gap-6 overflow-hidden overflow-y-auto rounded-sm">
                        ...
                        return (
                          ...
                          <Row key={idx}>
                            ...
                            {uploadDataHeaders.map(rowKey => (
                              <Cell
                                className="whitespace-nowrap border-b border-solid border-(--hl-sm) text-sm font-medium focus:outline-hidden group-last-of-type:border-none"
                                key={rowKey}
                              >
                                <span className="p-2">
              ...
              <div className="mt-2 flex justify-end">
                {userUploadData.length > 0 && (
                  <Button
                    className="flex items-center gap-2 rounded-xs border border-solid border-(--hl-md) px-3 py-2 text-(--hl) transition-colors hover:bg-opacity-90 hover:no-underline"
                ...
                <Button
                  ...
                  className="ml-4 flex items-center gap-2 rounded-xs border border-solid border-(--hl-md) bg-(--color-surprise) px-3 py-2 text-(--color-font-surprise) transition-colors hover:bg-opacity-90 hover:no-underline"
