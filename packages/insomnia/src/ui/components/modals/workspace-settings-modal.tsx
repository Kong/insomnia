        ...
        <Dialog className="flex h-full flex-1 flex-col overflow-hidden outline-hidden">
          {({ close }) => (
            ...
            >
              ...
              <div className="flex w-full flex-1 basis-96 select-none flex-col gap-2 overflow-hidden overflow-y-auto rounded-sm">
                <TextField
                  name="name"
                  isRequired
                ...
                >
                  ...
                  <Input
                    ...
                    className="w-full rounded-xs border border-solid border-(--hl-sm) bg-(--color-bg) p-2 text-(--color-font) transition-colors focus:outline-hidden focus:ring-1 focus:ring-(--hl-md)"
                  />
                </TextField>
