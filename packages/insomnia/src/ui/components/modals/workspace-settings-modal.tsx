...
export const WorkspaceSettingsModal = forwardRef<WorkspaceSettingsModalHandle, Props>((props, ref) => {
  ...
  useImperativeHandle(ref, () => ({
    ...
    show: () => {
      const hasDescription = !!props.workspace.description;
      setState({
        ...state,
              ...
              <div className="form-control form-control--outlined">
                <label>
                  ...
                  <DebouncedInput
                    ...
                    onChange={name => {
                      const { workspace, apiSpec } = props;
                      workspaceOperations.rename(workspace, apiSpec, name);
                    }}
                  />
                </label>
              </div>
                ...
                {showDescription ? (
                  <MarkdownEditor
                    ...
                    onChange={(description: string) => {
                      models.workspace.update(props.workspace, { description });
