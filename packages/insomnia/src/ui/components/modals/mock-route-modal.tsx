          ...
          <Form onSubmit={handleSubmit} className="flex flex-col gap-4 p-(--padding-md)">
            ...
            <div className="flex items-center justify-end gap-2 pt-4">
              <Button
                ...
                className="rounded-xs border border-solid border-(--hl-md) px-3 py-2 text-(--color-font) transition-colors hover:bg-opacity-90"
              >
                Cancel
              </Button>
              <Button
                type="submit"
                isDisabled={currentFetcher.state !== 'idle'}
                className="flex items-center justify-center gap-2 rounded-xs border border-solid border-(--hl-md) bg-(--color-surprise) px-3 py-2 text-center text-(--color-font-surprise) transition-colors hover:bg-opacity-90"
              >
                {title}
              </Button>
            </div>
