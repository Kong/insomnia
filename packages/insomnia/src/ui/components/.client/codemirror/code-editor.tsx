...
import { Button, Menu, MenuItem, MenuTrigger, Popover, type Selection, Toolbar } from 'react-aria-components';
...
export const CodeEditor = memo(
  ({
    ...
    ref?: React.RefObject<CodeEditorHandle | null> | React.RefCallback<CodeEditorHandle | null>;
  }) => {
