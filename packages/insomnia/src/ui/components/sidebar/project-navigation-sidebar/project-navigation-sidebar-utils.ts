...
export const ROW_CLASS =
  'relative flex h-(--line-height-xs) w-full items-center gap-1 overflow-hidden text-[rgba(var(--color-font-rgb),0.8)] outline-hidden transition-colors select-none group-hover:bg-(--hl-xs) group-aria-selected:bg-(--hl-xs) group-focus:bg-(--hl-sm) pr-4';
