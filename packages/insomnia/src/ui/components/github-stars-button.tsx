    ...
    <div className="flex select-none divide-x divide-solid divide-(--hl-md) rounded-lg border border-solid border-(--hl-md)">
      <Link onPress={starClick}>
        <a
          ...
          className="flex items-center justify-center gap-2 rounded-l-lg px-4 py-1 text-sm text-(--color-font) outline-hidden ring-transparent transition-all last-of-type:rounded-r-lg hover:bg-(--hl-xs) focus:ring-1 focus:ring-(--hl-md) aria-pressed:bg-(--hl-sm)"
        >
      ...
      {shouldShowCount && (
        <Link onPress={counterClick}>
          <a
            ...
            className="flex items-center justify-center gap-2 rounded-r-lg px-4 py-1 text-sm text-(--color-font) outline-hidden ring-transparent transition-all hover:bg-(--hl-xs) focus:ring-1 focus:ring-(--hl-md) aria-pressed:bg-(--hl-sm)"
          >
