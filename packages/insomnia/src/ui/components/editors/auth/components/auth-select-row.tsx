...
export const AuthSelectRow: FC<Props> = ({
  label,
  property,
  help,
  options,
  ...
  const selectedValue = authentication.hasOwnProperty(property)
  ...
  const onChange = useCallback(
    (event: ChangeEvent<HTMLSelectElement>) => {
      ...
      patcher(_id, {
        authentication: { ...authentication, [property]: updatedValue },
      });
    },
