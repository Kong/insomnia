...
export const signatureMethodOptions: {
  name: OAuth1SignatureMethod;
  value: OAuth1SignatureMethod;
}[] = [
  {
    name: "HMAC-SHA1",
...
export const OAuth1Auth: FC = () => {
  ...
  ).authentication as AuthTypeOAuth1;
  ...
  return (
    <AuthTableBody>
      ...
      />
      {signatureMethod === SIGNATURE_METHOD_RSA_SHA1 && (
        <AuthPrivateKeyRow label="Private Key" property="privateKey" />
      )}
