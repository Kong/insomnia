    ...
    <div className="flex h-full flex-col justify-center px-32">
      ...
      >
        ...
        <div className="mt-2 flex">
          <Button
            type="submit"
            className="mr-2 rounded-xs border border-solid border-(--hl-md) bg-[rgba(var(--color-surprise-rgb),var(--tw-bg-opacity))] bg-opacity-100 px-3 py-2 text-(--color-font-surprise) transition-colors hover:bg-opacity-90 hover:no-underline focus:ring-(--hl-md) aria-pressed:bg-opacity-80"
          >
          ...
          <Button
            ...
            className="flex items-center justify-center gap-2 rounded-xs bg-(--hl-xxs) px-3 py-2 text-sm text-(--color-font) ring-1 ring-transparent transition-all hover:bg-(--hl-xs) focus:ring-inset focus:ring-(--hl-md) aria-pressed:bg-(--hl-sm)"
          >
            Go to mock
          </Button>
        </div>
