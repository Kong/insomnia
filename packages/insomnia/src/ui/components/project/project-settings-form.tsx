        ...
        <>
          ...
          {insomniaFiles && insomniaFiles?.length > 0 && (
            <div className="flex flex-col gap-2">
              ...
              <div className="max-h-96 w-full select-none overflow-y-auto overflow-x-hidden rounded-sm border border-solid border-(--hl-sm)">
                <Table
                  selectionMode="none"
          ...
          {insomniaFiles && insomniaFiles?.some(file => file.path === '.insomnia') && (
            <div className="rounded-xs bg-[rgba(var(--color-warning-rgb),var(--tw-bg-opacity))] bg-opacity-50 p-(--padding-sm) text-(--color-font-warning)">
