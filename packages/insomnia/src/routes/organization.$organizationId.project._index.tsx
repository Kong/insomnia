          ...
          >
            <div className="flex flex-1 flex-col divide-y divide-solid divide-(--hl-md) overflow-hidden">
              <div className="h-[40px] p-(--padding-sm)">
                ...
                >
                  <Button className="flex flex-1 items-center justify-center gap-2 rounded-xs px-4 py-1 text-sm font-bold text-(--color-font) ring-1 ring-transparent transition-all hover:bg-(--hl-xs) focus:ring-inset focus:ring-(--hl-md) aria-pressed:bg-(--hl-sm)">
              ...
              {activeProject && (
                <>
                  ...
                  >
                    {item => {
                      return (
                        <GridListItem textValue={item.label} className="group select-none outline-hidden">
                          <div className="relative flex h-12 w-full select-none items-center gap-2 overflow-hidden px-4 text-(--hl) outline-hidden transition-colors group-hover:bg-(--hl-xs) group-focus:bg-(--hl-sm) group-aria-selected:bg-(--hl-sm) group-aria-selected:text-(--color-font)">
              ...
              <div className="flex w-full flex-col overflow-hidden">
                {billing.isActive ? null : (
                  <div className="p-(--padding-md) pb-0">
                    <div className="flex flex-wrap items-center justify-between gap-2 rounded-sm border border-solid border-(--hl-md) bg-[rgba(var(--color-warning-rgb),var(--tw-bg-opacity))] bg-opacity-50 p-(--padding-sm) text-(--color-font-warning)">
                      ...
                      {isUserOwner && (
                        <a
                          ...
                          className="flex items-center justify-center gap-2 rounded-xs border border-solid border-(--hl-md) bg-[rgba(var(--color-font-rgb),var(--tw-bg-opacity))] bg-opacity-100 px-4 py-1 text-sm font-semibold text-(--color-bg) ring-1 ring-transparent transition-all hover:bg-opacity-80 focus:ring-inset focus:ring-(--hl-md) aria-pressed:opacity-80"
                        >
                ...
                {billing?.expirationErrorMessage || billing?.expirationWarningMessage ? (
                  <div className="p-(--padding-md) pb-0">
                    <div
                      className={`flex flex-wrap items-center justify-between gap-2 rounded-sm border border-solid border-(--hl-md) bg-opacity-50 p-(--padding-sm) text-(--color-font-warning) ${billing?.expirationWarningMessage ? 'bg-[rgba(var(--color-warning-rgb),var(--tw-bg-opacity))]' : 'bg-[rgba(var(--color-danger-rgb),var(--tw-bg-opacity))]'}`}
                    >
                      <p className="text-base">
                        <Icon icon="exclamation-triangle" className="mr-2" />
                        {billing?.expirationErrorMessage || billing?.expirationWarningMessage}
                  ...
                  <div className="flex w-full max-w-xl justify-between gap-2 p-(--padding-md)">
                    ...
                    >
                      <Button
                        ...
                        className="flex aspect-square h-full shrink-0 items-center justify-center rounded-xs bg-(--hl-xxs) text-sm text-(--color-font) ring-1 ring-transparent transition-all hover:bg-(--hl-xs) focus:ring-inset focus:ring-(--hl-md) aria-pressed:bg-(--hl-sm)"
                      >
                        <Icon icon="sort" />
                      </Button>
                      <Popover className="flex min-w-max flex-col overflow-y-hidden">
                    ...
                    <MenuTrigger>
                      <Button
                        ...
                        className="flex h-full items-center justify-center gap-2 rounded-xs bg-(--hl-xxs) px-4 text-sm text-(--color-font) ring-1 ring-transparent transition-all hover:bg-(--hl-xs) focus:ring-inset focus:ring-(--hl-md) aria-pressed:bg-(--hl-sm)"
                      >
                ...
                <div className="flex-1 overflow-y-auto">
                  <GridList
                    aria-label="Files"
                    className="grid gap-4 p-(--padding-md) grid-cols-[repeat(auto-fit,200px)] grid-rows-[repeat(auto-fit,200px)] data-empty:flex data-empty:justify-center"
                    ...
                    {item => {
                      return (
                        <GridListItem
                          ...
                          className={`flex aspect-square w-full flex-1 select-none flex-col overflow-hidden rounded-md p-(--padding-md) outline-hidden ring-1 ring-(--hl-md) transition-all hover:bg-(--hl-xs) hover:shadow-md hover:ring-(--hl-sm) focus:bg-(--hl-sm) focus:ring-(--hl-lg) ${item.loading ? 'animate-pulse' : ''}`}
                        >
                          ...
                          <TooltipTrigger>
                            <Link onPress={item.action} className="line-clamp-4 pt-4 text-base font-bold outline-hidden">
                              {item.name}
                            </Link>
                            <Tooltip
                              offset={8}
