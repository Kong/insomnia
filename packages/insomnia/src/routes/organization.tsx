...
import { useInvalidateKonnectOrganization } from '~/ui/organization-utils';
...
const Component = () => {
  ...
  const invalidateKonnectOrganization = useInvalidateKonnectOrganization();
