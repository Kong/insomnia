...
export function useRequestUpdatePayloadActionFetcher(args?: Parameters<typeof useFetcher>[0]) {
  ...
  function submit({
    ...
    const url = href('/organization/:organizationId/project/:projectId/workspace/:workspaceId/debug/request/:requestId/update-payload', {
      organizationId,
      projectId,
      workspaceId,
      requestId,
    ...
    return fetcher.submit(JSON.stringify(payload), {
      action: url,
      method: 'POST',
