...
`utils/cn.ts` and `utils/variants.ts` are library-internal (tailwind-merge / tailwind-variants
helpers) and are **not** re-exported from the barrel — see [`AGENTS.md`](./AGENTS.md).
