...
export const isScratchpadProject = (project: Pick<Project, "_id">) =>
  project._id === SCRATCHPAD_PROJECT_ID;
export const isLocalProject = (
  project: Pick<Project, "remoteId">,
): project is LocalProject => project.remoteId === null;
export const isRemoteProject = (
  project: Pick<Project, "remoteId">,
): project is RemoteProject => !isLocalProject(project);
export const isGitProject = (project: Project): project is GitProject =>
  "gitRepositoryId" in project && project.gitRepositoryId !== null;
export const projectHasSettings = (project: Pick<Project, "_id">) =>
...
export function isDefaultOrganizationProject(project: Project) {
  ...
  return (
    project.remoteId?.startsWith("proj_team") ||
    project.remoteId?.startsWith("proj_org")
  );
}
