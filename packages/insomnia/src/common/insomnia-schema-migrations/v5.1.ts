 ...
 * and cookie timestamps, filters out empty entries, and removes empty arrays.
 *
 * Usage:
 ...
 * @returns Cleaned object with scoped `id`s and cookie timestamps removed, empty entries filtered out, and empty arrays removed
 */
