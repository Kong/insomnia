...
export const docsVersionControl = insomniaDocs(
  "/insomnia/version-control-sync",
);
...
export const docsWorkingWithDesignDocs = insomniaDocs(
  "/insomnia/design-documents",
);
...
export const docsPreRequestScript = insomniaDocs(
  "/insomnia/pre-request-script",
);
export const docsAfterResponseScript = insomniaDocs(
